document.addEventListener('DOMContentLoaded', function() {
    var maSoInput = document.getElementById('ma_so');
    var khachHangInput = document.getElementById('khach_hang');
    ...
    // Lắng nghe sự kiện 'submit' trên form có id 'withdraw_money_form'
    document.getElementById('withdraw_money_form').addEventListener('submit', function(event) {
